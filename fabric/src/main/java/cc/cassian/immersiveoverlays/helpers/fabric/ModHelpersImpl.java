...
public class ModHelpersImpl {
    ...
    public static TemperatureOverlay.TemperaturePair getBiomeTemperatureFromTag(Holder<Biome> biomeHolder) {
        if (ClientTags.isInWithLocalFallback(ConventionalBiomeTags.IS_HOT, biomeHolder)) {
        ...
        } else if (ClientTags.isInWithLocalFallback(ConventionalBiomeTags.IS_COLD, biomeHolder)) {
