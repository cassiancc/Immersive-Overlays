...
public class ModCompat {
    ...
    public static final boolean CAVERNS_AND_CHASMS = Platform.INSTANCE.isLoaded("caverns_and_chasms");
    ...
    public static final boolean SPELUNKERY = Platform.INSTANCE.isLoaded("spelunkery");
    public static final boolean SUPPLEMENTARIES = Platform.INSTANCE.isLoaded("supplementaries");
